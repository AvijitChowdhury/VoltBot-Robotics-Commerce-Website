  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-24 text-center lg:px-8">
        ...
        <h1 className="mt-3 font-display text-3xl font-bold sm:text-4xl">Sign in / Sign up</h1>
        <p className="mt-4 text-muted-foreground">Email/password + Google sign-in are coming in Phase 3.</p>
